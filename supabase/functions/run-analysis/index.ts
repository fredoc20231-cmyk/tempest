...
const MODULE_PROMPTS: Record<string, string> = {
  ...
  cnis: "Generate realistic CNIS (Neoantigen Intelligence) results for HGSOC GEM model. NetMHCpan 4.1b on H-2-Db/Kb. Include: MEIS1 F378X (Tier 1, 47.7% binding improvement, CD8+ recruitment confirmed), RBM26 S990FX (Tier 4, most recurrent but no human validation), SLFN8/SLFN11 (Tier 2, biomarker not neoantigen), ZKSCAN7 K404N (Tier 3, best binding 69.9% but zero human data). Fusion neoantigens: Mfhas1::Tns3 %Rank 0.133 (SB), Camk1d::Arid1a %Rank 0.519 (WB). Return as JSON with keys: metrics (array of {metric, value, trend}), narrative (string summary).",
